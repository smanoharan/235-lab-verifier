...
public class Application extends Controller 
{
    ...
    private static RunResults toResult(Machine machine, String type) throws Exception
    {
      ...
      String testPath = "app/t" + type + ".txt";
      return Tester.testMachine(machinePath, testPath, type);
    }

    public static void checkAll(Machine m11, Machine m12, Machine m13, Machine m21, Machine m22, Machine m31, Machine m32, Machine m41)
    {
      ...
      for (int i=0; i<machines.length; i++)
      {
        ...
        {
          count++;
          try { allResults.add(toResult(machines[i], mtypes[i])); }
          catch (Exception e) { renderText("index: " + i + ", qs: " + mtypes[i] + ", error: " + e.getMessage()); }
        }
      }
